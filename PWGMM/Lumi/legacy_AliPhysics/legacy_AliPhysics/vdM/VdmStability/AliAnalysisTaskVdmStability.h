...
class AliAnalysisTaskVdmStability : public AliAnalysisTaskSE
{
 ...
 public:
  ...
  void SetDiffTimingCut(Float_t min, Float_t max)
  {
    fV0TimeDiff_min = min;
    fV0TimeDiff_max = max;
  }
  void SetSumTimingCut(Float_t min, Float_t max)
  {
    fV0TimeSum_min = min;
    fV0TimeSum_max = max;
  }
 ...
 private:
  ...
  Bool_t CheckZVtx(Double_t zVtx, Int_t nCont, Double_t zCut, Bool_t contCut,
                   Int_t nContCut);
