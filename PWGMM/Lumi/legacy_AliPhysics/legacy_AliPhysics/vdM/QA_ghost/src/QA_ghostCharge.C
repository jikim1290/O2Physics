...

{
  ...
  if (save) {
    ...
    TString plotName = "";
    if (opt == 0)
      plotName = Form("../Fill-%d/ghostCharge/ghostCharge_B1_A_%s.pdf", Fill,
                      unc.Data());
    if (opt == 1)
      plotName = Form("../Fill-%d/ghostCharge/ghostCharge_B1_B_%s.pdf", Fill,
                      unc.Data());
    if (opt == 2)
      plotName = Form("../Fill-%d/ghostCharge/ghostCharge_B2_A_%s.pdf", Fill,
                      unc.Data());
