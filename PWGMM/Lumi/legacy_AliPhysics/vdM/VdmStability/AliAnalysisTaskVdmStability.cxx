...
ClassImp(AliAnalysisTaskVdmStability)
  ...
  AliAnalysisTaskVdmStability::AliAnalysisTaskVdmStability() : AliAnalysisTaskSE(),
                                                               fOutputList(),
                                                               fRunNumber(0),
                                                               fVtxZ(-999.),
                                                               fnVtxCont(0),
...
//_________________________________________________________________________________
AliAnalysisTaskVdmStability::AliAnalysisTaskVdmStability(const char* taskname) : AliAnalysisTaskSE(taskname),
                                                                                 fOutputList(),
                                                                                 fRunNumber(0),
                                                                                 fVtxZ(-999.),
                                                                                 fnVtxCont(0),
